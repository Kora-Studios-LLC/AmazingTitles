...
public class FadeInAnimationComponent implements AnimationComponent {
	...
	* */
	...
	public FadeInAnimationComponent(Plugin plugin, LinkedList<String> frames, String mainText, String subText, int fps, int duration, DisplayType displayType, BarColor componentColor) {
		this.plugin = plugin;
		this.frames = frames;
