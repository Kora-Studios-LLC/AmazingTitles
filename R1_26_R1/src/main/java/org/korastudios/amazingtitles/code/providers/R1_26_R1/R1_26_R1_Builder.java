package org.korastudios.amazingtitles.code.providers.R1_26_R1;
...
public class R1_26_R1_Builder implements NmsBuilder {
	
	@Override
	public boolean checked(String version) {
		String normalized = version.toLowerCase(Locale.ROOT);
		return normalized.startsWith("v1_26_r1") || normalized.startsWith("26.");
	}
