...
- Build the full plugin (all version providers) with `mvn clean package -pl Build -am -DskipTests`. The shaded plugin jar lands at `Build/target/AmazingTitles-6.1-STABLE.jar`.
